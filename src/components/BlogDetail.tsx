...
const blogData = [
  {
    ...
    sections: [
      ...
      { type: 'bullets', items: [
        ...
        'Social Media Marketing: building audience trust and engagement on Instagram, LinkedIn and more',
      ...
      { type: 'heading', content: 'Why Mumbai Businesses Cannot Afford to Wait' },
      ...
      { type: 'paragraph', content: 'Businesses that invested in digital marketing early are now reaping compounding returns, including better search rankings, larger audiences, and lower customer acquisition costs. The longer you wait, the further behind you fall.' },
      { type: 'heading', content: 'The ROI of Going Digital' },
      { type: 'paragraph', content: 'Unlike traditional advertising such as hoardings, print, or TV, digital marketing gives you full visibility into what\'s working. You can track every click, every lead, and every rupee spent and earned. This level of accountability means you can continuously optimise and scale what works, making your marketing budget go further every month.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'Social media platforms have matured. Organic reach is harder, algorithms are smarter, and audiences are more selective about the content they engage with. The brands winning on social media in 2026 are not posting more. They\'re posting smarter.' },
      { type: 'heading', content: '7 Strategies That Actually Drive Results' },
      { type: 'subheading', content: '1. Short Form Video First' },
      { type: 'paragraph', content: 'Instagram Reels and YouTube Shorts continue to receive the highest organic reach of any content format. Brands that lead with short form video consistently outperform those that don\'t. Aim for 15 to 45 second videos that educate, entertain, or inspire.' },
      { type: 'subheading', content: '2. Niche Community Building' },
      { type: 'paragraph', content: 'Instead of broadcasting to everyone, build a community around your brand\'s core niche. Engage in comment sections, respond to DMs, create polls and questions, and make your audience feel heard and valued.' },
      ...
      { type: 'paragraph', content: 'Micro influencers with 10,000 to 100,000 followers in your niche consistently outperform mega influencers in engagement and conversion. Partner with creators whose audience genuinely matches your target customer.' },
      ...
      { type: 'subheading', content: '7. Paid and Organic Integration' },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'Your website needs to be fast, mobile-friendly, and correctly structured for Google to crawl and index it effectively. Core Web Vitals including page speed, interactivity, and layout stability are now direct ranking factors.' },
      ...
      { type: 'subheading', content: '4. Off-Page SEO and Backlinks' },
      { type: 'paragraph', content: 'Backlinks, which are links from other reputable websites to yours, remain one of Google\'s strongest ranking signals. Building relationships, getting featured in industry publications, and creating shareable content all contribute to a strong backlink profile.' },
      ...
      { type: 'bullets', items: [
        ...
        'Create location pages targeting specific Mumbai areas such as Andheri, Bandra, and Powai',
        'Use structured data markup (Schema) to help Google understand your business',
      ]},
      { type: 'heading', content: 'How Long Does SEO Take?' },
      { type: 'paragraph', content: 'SEO is a long-term investment. Most businesses start seeing meaningful results within 3 to 6 months, with significant ranking improvements in 6 to 12 months. The key is consistency, including regular content, ongoing technical improvements, and continuous link building.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'Performance marketing is advertising where you only pay for results such as clicks, leads, purchases, or sign-ups. Unlike traditional advertising where you pay for exposure with no guarantee of return, performance marketing is fully accountable and measurable.' },
      ...
      { type: 'subheading', content: 'Meta Ads (Facebook and Instagram)' },
      ...
      { type: 'bullets', items: [
        'Start with any budget: even Rs. 500 per day can generate measurable results',
        ...
        'Retargeting: bring back visitors who did not convert the first time',
      ]},
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'bullets', items: [
        'Mega Influencers (1M and above): Maximum reach, best for brand awareness campaigns',
        'Macro Influencers (100K to 1M): Balance of reach and engagement, good for broad campaigns',
        'Micro Influencers (10K to 100K): Highest engagement rates, strongest audience trust, best for conversions',
        'Nano Influencers (1K to 10K): Hyper-local, extremely authentic, ideal for community-based products',
      ]},
      { type: 'heading', content: 'How to Vet an Influencer Before Partnering' },
      { type: 'bullets', items: [
        'Check engagement rate: likes and comments relative to follower count (aim for 3% and above)',
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'Many businesses confuse a logo with a brand identity. A logo is just one visual element. A brand identity is the complete system, including colours, typography, tone of voice, imagery style, and the overall feeling your brand creates in the mind of your customer.' },
      ...
      { type: 'bullets', items: [
        ...
        'Having no defined brand voice and sounding different in every piece of content',
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'subheading', content: 'Performance and Speed' },
      { type: 'bullets', items: [
      ...
      { type: 'bullets', items: [
        ...
        'Clean URL structure with no long or messy URLs',
      ]},
      ...
      { type: 'bullets', items: [
        ...
        'Trust signals including testimonials, reviews, certifications, and client logos',
      ]},
      { type: 'subheading', content: 'Security and Technical' },
      { type: 'bullets', items: [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'An advertising agency focuses on the creative side of marketing, including developing campaigns, writing copy, designing visuals, producing videos, and building the messaging and creative assets that represent your brand. Their output is the actual ads and content.' },
      ...
      { type: 'bullets', items: [
        ...
        'Full-Service Agency (like Trends of Media): Does both, handling creative and media planning under one roof',
      ]},
      { type: 'heading', content: 'Which One Do You Need?' },
      { type: 'paragraph', content: 'For most growing businesses in Mumbai, working with a full-service digital marketing agency is the most efficient choice. You get both the creative strategy and the media execution in one place, with no coordination overhead and no misalignment between what\'s created and where it runs.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'Ask for case studies, client testimonials, and specific results they\'ve achieved, including traffic growth percentages, lead generation numbers, and ROAS on ad campaigns. Any agency worth hiring can show you evidence of their work.' },
      ...
      { type: 'paragraph', content: 'An agency that understands your industry, including your customers, your competitors, and your market dynamics, will produce far better work than one learning your business from scratch.' },
      { type: 'subheading', content: '5. Cultural Fit' },
      { type: 'paragraph', content: 'You\'re entering a long-term relationship. The agency team should feel like an extension of yours, being responsive, collaborative, and genuinely invested in your success.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'bullets', items: [
        ...
        'Branding and Creative Identity: logos, visual systems, and brand strategy',
